    ...
    async createManagedEmailConfig(instanceId, instanceName) {
        try {
            ...
            const result = await pool.query(`
                ...
                (instance_id, config_type, email_address, auto_extract_control_numbers, include_attachments)
                VALUES ($1, $2, $3, $4, $5)
                RETURNING *
            `, [instanceId, 'managed', emailAddress, true, true]);
        ...
        try {
            ...
            const result = await pool.query(`
                ...
                (instance_id, config_type, email_address, 
                 ...
                 auto_extract_control_numbers, include_attachments, default_folder_id)
